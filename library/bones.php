...
function bones_theme_support() {
	...
	register_nav_menus(
		array(
			...
			'adviser-nav' => 'Adviser Menu',
			'member-nav' => 'Member Menu',
...
// the main menu
function bones_adviser_nav() {
    wp_nav_menu(array(
        'container' => false,                                  // remove nav container
        'container_class' => 'menu clearfix',           // class of container (should you choose to use it)
        'menu' => 'adviser_nav',                          // nav name
        'menu_class' => 'nav clearfix',                   // adding custom nav class
        'theme_location' => 'adviser-nav',            // where it's located in the theme
        'before' => '',                                            // before the menu
        'after' => '',                                              // after the menu
        'link_before' => '',                                     // before each link
        'link_after' => '',                                       // after each link
