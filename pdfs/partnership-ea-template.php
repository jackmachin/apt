...
with the Pensions Regulator’s notification on 1st April 2012.The figure is based on PAYE workers.
                ...
                <tr>
                    <th>Re-enrolment</th>
                    <td>The re-enrolment date is on every third anniversary of the Employer’s staging date and the Employer must re-assess all workers on the re-assessment date. This includes active members of the Scheme or any person who, in the previous 12 months prior to the re-enrolment date, has ceased membership.
The Employer may opt to move their re-enrolment date to any day, up to three months before or after each third anniversary.
</td>
                    <td>As per legislation</td>
                </tr>
                <tr>
                    <th>The Opt-out process</th>
                    <td>Administering the opt-out process for workers who decide they do not want to be a member of the Scheme. This is to be agreed with the Administrator. The Employer must inform workers of the right to opt out and how to opt out. The one month opt out window starts on the latter of two dates: when active membership is achieved and when the Employer issues a letter/email to the jobholder.</td>
                    <td>As per legislation</td>
                </tr>
                <tr>
                    <th>Specific information</th>
                    <td>Giving specified information to groups of workers within the specified categories (Eligible Jobholders, Non-eligible jobholders and Entitled Workers).</td>
                    <td>As per legislation</td>
                </tr>
                <tr>
                    <th>Record Keeping</th>
                    <td>The Administrator has the responsibility of keeping records of the Scheme for at least six years, The Pensions Regulator can ask the Employer to provide the information and therefore the Administrator is obliged to provide the information in a timely manner.</td>

                    <td>As per legislation</td>
                </tr>
                <tr>
                    <th>Fees</th>
                    <td>The Employer agrees to pay the administration fees in accordance with the agreed terms</td>
                    <td></td>
                </tr>
            </tbody>
        </table>
        <pagebreak>
        <p class="front">SCHEDULE 2</p>
        <p class="front">METHODS OF COMMUNICATION</p>
        <table class="fancy-table">
            <thead>
                <tr>
                    <th width="30%">Event</th>
                    <th width="50%">Method of Communication Permitted /th>
                    <th width-"20%">Authority Required</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <th>Notification from the Employer to the Administrator authorising specified persons to give instructions on behalf of the Employer in relation to the provision of Services</th>
                    <td>Writing, including facsimile and email transmission</td>
                    <td>To be signed by an authorised signatory of the Employer.</td>
                </tr>
                <tr>
                    <th>Notification from the Administrator to The Employer of change of principal contact for the provision of the Services</th>
                    <td>Writing, including facsimile and email transmission</td>
                    <td>To be signed by an authorised signatory of the Administrator.</td>
                </tr>
                <tr>
                    <th>Instructions from the Employer/authorised persons on behalf of the Employer  to the Administrator in relation to the provision of Services</th>
                    <td>Writing, including facsimile and email transmission.</td>
                    <td>To be signed by an authorised signatory of the Employer/person authorised on behalf of the Employer, save for e-mail, which should be followed up with a signed authority.</td>
                </tr>
            </tbody>
            </table>
        <pagebreak>
        <p class="front">SCHEDULE 3</p>
        <p class="front">ADMINISTRATION AGREEMENT</p>
        <p>The Administration Agreement between Amber Financial Investments Limited (1), Amber Trustees Limited and Carey Corporate Trustees UK Limited (2) and Carey Corporate Pensions UK Limited (3) and dated 10th January 2014 a copy of which is available on request to the Administrator.</p>
    </body>
</html>
