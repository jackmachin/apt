...
<head>
	...
	<body>
        ...
        <ol>
            ...
            <li><strong><?php echo $employer_name;?></strong> an unincorporated company whose registered office is at <?php echo $address_street;?>, <?php echo $address_city;?>, <?php echo $address_country;?>, <?php echo $address_code;?> (the “<strong>New Participating Employer</strong>”).
                <br>
                <br>
            </li>
        </ol>
        ...
        <ol>
            ...
            <li>The Trustees are the present Trustees of the Scheme.
                <br>
                <br>
            </li>
